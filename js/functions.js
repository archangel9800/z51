            ...
            $.get({
                ...
                success: function (data) {
                    ...
                    $.each(data, function () {
                        ...
                        out += '<p class="m-0">Цена: <span>' + this.price + '</span></p>';
//                        if (this.enabled <= 0) {
//                            out += '<p class="m-0">Цена: <span>' + this.price + '.</span> На складе: <span>Нет.</span></p>';
//                        } else if (this.enabled == 1) {
//                            out += '<p class="m-0">Цена: <span>' + this.price + '.</span> На складе: <span>Заканчивается.</span></p>';
//                        } else if (this.enabled > 1 && this.enabled <= 4) {
//                            out += '<p class="m-0">Цена: <span>' + this.price + '.</span> На складе: <span>Мало.</span></p>';
//                        } else {
//                            out += '<p class="m-0">Цена: <span>' + this.price + '.</span> На складе: <span>Много.</span></p>';
//                        }
                        out += '</div></div></a></li>';
                    });
...
///adress autocomplite script start

///dress autocomplite end script
