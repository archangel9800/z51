...
///.mainMenuSecondaryDropdownWidth script start  
    ...
    //   var menuWidth = 300;
        if (navigator.userAgent.search("Edge") >= 0 && $(window).width() >= 976) {
             secondaryDropdown.css({
               width: mainWidth - menuWidth
            }); 
        } else if (navigator.userAgent.search("Edge") >= 0 && $(window).width() < 976){
               secondaryDropdown.css({
               width: mainWidth
            });    
        } else if (navigator.userAgent.search("Edge") < 0 && $(window).width() >= 983){
               secondaryDropdown.css({
